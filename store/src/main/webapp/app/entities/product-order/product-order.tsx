      ...
      <div>
        <h2 id="product-order-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            ...
            &nbsp;
            <Translate contentKey="storeApp.productOrder.home.createLabel">Create a new Product Order</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {productOrderList && productOrderList.length > 0 ? (
            <Table responsive aria-describedby="product-order-heading">
              <thead>
                <tr>
