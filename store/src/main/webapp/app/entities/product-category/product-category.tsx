      ...
      <div>
        <h2 id="product-category-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            ...
            &nbsp;
            <Translate contentKey="storeApp.productCategory.home.createLabel">Create a new Product Category</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {productCategoryList && productCategoryList.length > 0 ? (
            <Table responsive aria-describedby="product-category-heading">
              <thead>
                <tr>
                  <th>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="storeApp.productCategory.home.notFound">No Product Categories found</Translate>
            </div>
          )}
        </div>
      </div>
